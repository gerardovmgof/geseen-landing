...
export const SITE = {
  whatsapp: "5215642480361",
  email: "contacto@geseen.com.mx",
  waMessage: {
    es: "Hola GESEEN, quiero platicar sobre un proyecto.",
    en: "Hi GESEEN, I'd like to talk about a project.",
  },
  // ID del Meta Pixel (Business Suite → Administrador de eventos → Orígenes de datos).
  // Vacío = el pixel no se carga. Pegar aquí el número cuando exista la cuenta.
  metaPixelId: "",
};
